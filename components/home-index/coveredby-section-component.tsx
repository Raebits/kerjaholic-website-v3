...
export default function CoveredBySectionHome(): JSX.Element {
    ...
    return (
        <div className = " bg-white px-5 md:px-10">
            <div className = " flex justify-center text-3xl font-bold py-5">Diliput Oleh</div>
                ...
                listCoveredByData.map((prop, index) => {
                    return (
                        <div key={"CoveredByData" + index} className = "w-full lg:w-1/3 flex justify-center items-center">
                            <div style={{cursor: "pointer"}} className="block w-full mx-2 my-3 h-48 bg-white ">

                                    <img  className="object-left" src={prop.img} alt="Article image"/>
                                
                                <div className="mb-1 mt-3 text-md md:text-xl font-bold tracking-tight text-gray-900 ">
                                {prop.title}
                                </div>

...
export default function Header({ title, useSearching, useSorting, children, onSearching, onSorting, mainPage , onBack }: StickyHeaderProps): JSX.Element {

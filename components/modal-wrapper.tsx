...
export default function ModalWrapper({ children, showed, setShowed, loading }: ModalWrapperProps): JSX.Element {
    ...
    return (
        ...
        <div className = {`${!showed ? '-translate-y-full' : 'translate-y-0'} bg-opacity-60 transition transform ease-in-out duration-500 w-full fixed -top-0 flex justify-center items-center h-screen z-40`}>
